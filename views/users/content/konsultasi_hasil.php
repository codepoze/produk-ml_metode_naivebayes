    ...
    <div class="animated fadeIn">
        <div class="row">
            <div class="col-lg-12">
                ...
                foreach ($evaluasi as $key => $value) {
                    foreach ($alternatif as $key_alternatif => $value_alternatif) {
                        if ($value['id_alternatif'] === $key_alternatif) {
                            ...
                            $kelasId[$value_alternatif] = $value['id_alternatif'];
                        }
                    }
                }
                ...
                foreach ($kelas as $keyKelas => $valueKelas) {
                    foreach ($kriteria as $keyAtribut => $valueAtribut) {
                        $konsultasiResult[$keyKelas][$keyAtribut] = $last[$keyKelas][$keyAtribut][$kriteria_sub[$keyAtribut][$konsultasi[$keyAtribut]]];
                    }
                }
                ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody align="center">
                                <?php foreach ($kriteria as $key => $value) : ?>
                                    <th><?= $kriteria_sub[$key][$konsultasi[$key]] ?></th>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody align="center">
                                <tr>
                                    <?php foreach ($kriteria as $key => $value) : ?>
                                        <td><?= $kriteria_sub[$key][$konsultasi[$key]] ?></td>
                                    <?php endforeach; ?>
                                    <?php foreach ($kelas as $keyKelas => $valueKelas) {
                                        $hitung = array_product($konsultasiResult[$keyKelas]);
                                        $hasil  = round($hitung, 2);
                                        $rank[$keyKelas] = $hasil;
                                        $lastResult[$kelasId[$keyKelas]] = $hasil;
                                    ?>
                                        <td><?= $hasil ?></td>
                                    <?php } ?>
                                    <td>
