                                    ...
                                    <div class="tab-pane fade show active" id="nav-akun" role="tabpanel" aria-labelledby="akun">
                                        <form action="aksi/?aksi=profil_akun" id="form-akun" method="post">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="nama" id="nama" class="form-control form-control-sm" placeholder="Masukkan Nama" value="<?= $rowLog->nama ?>" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="email" name="email" id="email" class="form-control form-control-sm" placeholder="Masukkan Email" value="<?= $rowLog->email ?>" />
                                                    <small class="help-block form-text error"></small>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="telepon" id="telepon" class="form-control form-control-sm" placeholder="Masukkan Telepon" value="<?= $rowLog->telepon ?>" />
                                                    <small class="help-block form-text error"></small>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="date" name="tgl_lahir" id="tgl_lahir" class="form-control form-control-sm" value="<?= $rowLog->tgl_lahir ?>" />
                                                    <small class="help-block form-text error"></small>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="tmp_lahir" id="tmp_lahir" class="form-control form-control-sm" placeholder="Masukkan Tempat Lahir" value="<?= $rowLog->tmp_lahir ?>" />
                                                    <small class="help-block form-text error"></small>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-control form-control-sm" name="kelamin" id="kelamin">
                                                        ...
                                                        <option <?= $rowLog->kelamin === 'L' ? 'selected' : '' ?> value="L">Laki-laki</option>
                                                        <option <?= $rowLog->kelamin === 'P' ? 'selected' : '' ?> value="P">Perempuan</option>
                                                    </select>
                                                    <small class="help-block form-text error"></small>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="alamat" id="alamat" class="form-control form-control-sm" placeholder="Masukkan Alamat"><?= $rowLog->alamat ?></textarea>
                                                    <small class="help-block form-text error"></small>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="username" id="username" class="form-control form-control-sm" placeholder="Masukkan Username" value="<?= $rowLog->username ?>" />
                                                    <small class="help-block form-text error"></small>
                                                </div>
                                            </div>
